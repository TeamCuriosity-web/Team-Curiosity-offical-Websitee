...
const Hero = () => {
  ...
  useLayoutEffect(() => {
    const ctx = gsap.context(() => {
       ...
       // Main Title Glitch Entry (Standard GSAP)
       tl.from(".hero-title", {
           y: 50,
           opacity: 0,
           duration: 1,
           stagger: 0.1,
           delay: 1.5 // Wait for boot text
       })
       // Subtitle & Buttons
       .from(".hero-content", {
           opacity: 0,
    ...
    <section ref={containerRef} className="relative min-h-screen flex flex-col justify-center pt-24 pb-12 overflow-hidden border-b-2 border-black">
        ...
        <div className="container mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-8 flex flex-col gap-8">
                ...
                {/* Massive Typography */}
                <h1 className="text-6xl md:text-8xl lg:text-9xl font-black tracking-tighter text-black leading-[0.85] uppercase animate-breathe" style={{ animationDelay: '2.5s' }}>
                    <span className="hero-title block">We Build</span>
                    <span className="hero-title block text-transparent bg-clip-text bg-gradient-to-r from-black via-black to-gray-500">The Future</span>
                </h1>

                <div className="hero-content flex flex-col gap-8 max-w-2xl">
                    <p className="text-xl md:text-2xl text-black font-medium leading-relaxed border-l-4 border-black pl-6 py-2">
            ...
            <div className="hidden lg:flex lg:col-span-4 flex-col justify-end h-full min-h-[500px] border-l-2 border-black pl-8 hero-content">
                 <div className="mt-auto space-y-4 font-mono text-xs">
                    ...
                    <div className="pt-8 opacity-50">
                        {Array(6).fill(0).map((_, i) => (
                            <div key={i} className="truncate text-[10px] text-gray-400">
